...
package stroom.template.set.impl.db.migration;
...
public class V07_06_00_200__template_set_pre_migration_checks extends BaseJavaMigration {

    private static final LambdaLogger LOGGER = LambdaLoggerFactory
            .getLogger(V07_06_00_200__template_set_pre_migration_checks.class);
